...
class Config:
    ...
    def __init__(self):
        ...
        self._mapping = {
            ...
            "JOB_FILTER_INCLUDE_ROLE_TAGS": "job_discovery.filters.include_role_tags",
            "JOB_FILTER_EXCLUDE_ROLE_TAGS": "job_discovery.filters.exclude_role_tags",
            "JOB_FILTER_INCLUDE_STACK_TAGS": "job_discovery.filters.include_stack_tags",
            "JOB_FILTER_EXCLUDE_STACK_TAGS": "job_discovery.filters.exclude_stack_tags",
